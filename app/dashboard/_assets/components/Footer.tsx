...
const Footer = () => {
  return (
    <div className="min-h-[35px] bg-secondary flex items-center flex-col md:flex-row justify-between text-[11px] font-normal px-4 md:px-8 py-1 md:py-0 dark:text-[#B2B2B2] arial text-[#6a6a6a]">
      {/* Logo and text */}
