...
const DashboardPage = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:space-x-3 xl:space-x-16 space-y-10 lg:space-y-0">
      <div className="space-y-6 max-w-[400px] lg:max-w-[450px] xl:max-w-[600px]">
        <div className="relative z-10">
          <h1 className="text-2xl md:text-4xl font-bold mb-2 text-primary z-10">Welcome to the EliteCore</h1>
          <p className="max-w-[480px] whitespace-break-spaces text-justify z-10">
