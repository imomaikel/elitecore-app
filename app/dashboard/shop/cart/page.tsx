...
import SignInConfirm from '@/components/shared/SignInConfirm';
...
const CartPage = () => {
  ...
  if (!isMounted) return <CartPage.Skeleton />;
        ...
        <div className="flex flex-col flex-1 space-y-8 relative z-10 mb-16">
          ...
          <div className="relative z-10">
            ...
            {sessionStatus === 'authenticated' && user ? (
              ...
              <p>To use a gift card you need to be logged in</p>
            )}
          </div>
          <Separator />
          {/* Products */}
          ...
          {/* Second checkout */}
          <div className="!mt-16">
            <CheckoutButton className="max-w-md w-full" onClick={() => setIsDialogOpen(true)} />
          </div>
...
CartPage.Skeleton = function ShowSkeleton() {
  return (
    <div className="max-w-10xl flex">
      <div className="flex flex-col flex-1 space-y-8 relative z-10 mb-16">
        <div className="relative z-10 flex items-center space-x-6">
