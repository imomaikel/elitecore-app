...
const ControlCartItem = ({ basketItem, category, productData }: TControlCartItem) => {
  ...
  return (
    <div className="max-w-2xl flex relative z-10">
      ...
      <div className="pl-3 z-10 relative flex w-full flex-col">
        {/* Header */}
        <div className="flex items-center w-full h-min justify-between">
      ...
      <div className="bg-gradient-to-r from-fuchsia-600 to-pink-600 absolute z-0 w-[30%] h-[60%] right-0 rotate-45 bottom-6 blur-[200px] opacity-50" />
    </div>
  );
};
    ...
    <div className="max-w-2xl flex relative z-10">
      ...
      <div className="pl-3 z-10 relative flex w-full flex-col">
        <div className="flex items-center w-full h-min justify-between">
          ...
          <div className="flex">
            <Skeleton className="w-20 h-9 mx-1" />
            <Skeleton className="w-28 h-9 mx-1" />
          </div>
        </div>
