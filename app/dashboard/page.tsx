    ...
    <div>
      ...
      <div>
        ...
        <p className="max-w-[480px] whitespace-break-spaces text-justify">
          EliteCore is a x1000 cluster with a friendly and healthy community. In order to get you started and ready for
          pvp quickly, we have great kits and a large shop! On our site you will find all the information you require.
          From game links all the way to donations!
        </p>
      </div>
      {/* Top Donator */}
      <div>
